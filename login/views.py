...
def send_email(email, code):
    ...
    subject = '来自--CMDB--的注册确认邮件'

    text_content = '''感谢注册blog.csdn.net/qq_24027457，这里是华张辉的博客和教程站点，专注于运维技术的分享！\
                    如果你看到这条消息，说明你的邮箱服务器不提供HTML链接功能，请联系管理员！'''

    html_content = '''
                    <p>感谢注册<a href="http://{}/login/user_Confirm/?code={}" target=blank>https://blog.csdn.net/qq_24027457</a>，\
